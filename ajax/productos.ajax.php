...
class AjaxProductos{
	...
	MOSTRAR SALIDAS
	============================================*/
	public function ajaxMostrarSalidas(){
		$respuesta = ControladorProductos::ctrMostrarSalidas();
		echo "$respuesta";
	}
	/*=============================================
  	ACTIVAR PRODUCTOS
...
if(isset($_POST["tituloProducto"])){
	...
	$producto -> stockMin = $_POST["stockMin"];
	$producto -> stockMax = $_POST["stockMax"];
...
if(isset($_POST["id"])){
	...
	$editarProducto -> stockMin = $_POST["stockMin"];
	$editarProducto -> stockMax = $_POST["stockMax"];
	...
	$editarProducto -> ajaxMostrarSalidas();

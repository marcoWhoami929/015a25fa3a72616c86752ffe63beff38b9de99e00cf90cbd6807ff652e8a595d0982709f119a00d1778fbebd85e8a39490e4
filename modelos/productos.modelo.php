...
class ModeloProductos{
	...
	MOSTRAR SALIDAS
	=======================================*/
	static public function mdlMostrarSalidas($tabla){
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla set salidas = ventas");

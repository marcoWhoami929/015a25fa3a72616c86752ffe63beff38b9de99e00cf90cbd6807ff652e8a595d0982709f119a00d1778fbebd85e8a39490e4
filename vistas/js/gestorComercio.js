			...
			success: function(respuesta){
				...
				if(respuesta == "ok"){
					...
					swal({
				      ...
				      text: "¡El logotipo ha sido actualizado correctamente!",
				      type: "success",
				      confirmButtonText: "¡Cerrar!"
				    });
		...
		$.ajax({
			...
			success: function(respuesta){
				...
				if(respuesta == "ok"){
					...
					swal({
				      title: "Cambios guardados",
				      text: "¡El ícono ha sido actualizado correctamente!",
				      type: "success",
				      confirmButtonText: "¡Cerrar!"
				    });
		...
		$.ajax({
			...
			success: function(respuesta){
				...
				if(respuesta == "ok"){
					...
					swal({
				      title: "Cambios guardados",
				      text: "¡La tienda en línea ha sido actualizada correctamente!",
				      type: "success",
				      confirmButtonText: "¡Cerrar!"
				    });
...
$("input[name='colorRedSocial']").on("ifChecked", function(){
	...
	var redes = ["facebook", "whatsapp","twitter","google-plus","instagram"];

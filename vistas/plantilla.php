...
?>
        ...
        <script src="vistas/js/gestorInventarios.js"></script>
        <script src="vistas/js/gestorBanner.js"></script>
        <script src="vistas/js/gestorVentas.js"></script>
        <script src="vistas/js/gestorPedidos.js"></script>
        ...
        <script src="vistas/js/gestorVentasCategorias.js"></script>

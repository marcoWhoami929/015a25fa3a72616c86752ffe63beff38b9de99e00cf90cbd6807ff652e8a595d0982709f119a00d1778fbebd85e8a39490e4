           ...
           <!--=====================================
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <textarea type="text" maxlength="5000" rows="3" class="form-control input-lg descripcionProducto" placeholder="Ingresar descripción producto"></textarea>
            ...
            <div class="form-group row">
            	<div class="col-md-4 col-xs-12">
            		...
            		<div class="input-group">
            			...
            			<input type="number" class="form-control input-lg largo" min="0" step="any" placeholder="Largo">
            	...
            	<div class="col-md-4 col-xs-12">
            		...
            		<div class="input-group">
            			...
            			<input type="number" class="form-control input-lg ancho" min="0" step="any" placeholder="Ancho">
            	...
            	<div class="col-md-4 col-xs-12">
            		...
            		<div class="input-group">
            			...
            			<input type="number" class="form-control input-lg alto" min="0" step="any" placeholder="Alto">
            ...
            <div class="form-group row">
            	<div class="col-md-4 col-xs-12">
            		...
            		<div class="input-group">
            			...
            			<input type="number" class="form-control input-lg stock" placeholder="Stock">
            	...
            	<div class="col-md-4 col-xs-12">
            		...
            		<div class="input-group">
            			...
            			<input type="number" class="form-control input-lg stockMin" min="1" max="10" value="1" placeholder="Stock mínimo">
            	...
            	<div class="col-md-4 col-xs-12">
            		...
            		<div class="input-group">
            			...
            			<input type="number" class="form-control input-lg stockMax" min="1" max="20" value="10" placeholder="Stock máximo">

      ...
      <div class="box">
        ...
        <div class="box-body">
                <?php 
                      ...
                      define("DB_USER", 'root');
                      define("DB_PASSWORD", '');
                      define("DB_NAME", 'sfdeshop');
                      define("DB_HOST", 'localhost');
                      define("BACKUP_DIR", 'Respaldos-eshop'); // Comment this line to use same script's directory ('.')
        ...
        <div class="box-footer">
          <strong>Nota importante:</strong><p>Se recomienda realizar el respaldo diario de la tienda para evitar pérdida de datos, si se realiza alguna alta de productos, categorías o algún dato importante generar respaldo.</p>
